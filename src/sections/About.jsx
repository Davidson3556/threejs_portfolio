      ...
      <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            <img src="assets/wale.png" alt="me" className="w-full  sm:h-[276px] h-fit object-contain" />

            <div>
              <p className="grid-headtext">Hi, I’m Olawale Awokoya</p>
              <p className="grid-subtext">
                With 4 years of experience, I have honed my skills in frontend , creating dynamic
                and responsive websites using Nextjs, React, Vuejs, typescript and TailwindCSS.
              </p>
            </div>
          </div>
        </div>
